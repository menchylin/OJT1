 ...
 */
function wk_wow_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'wk_wow_custom_header_args', array(
		...
		'height'                 => 1080,
		'flex-height'            => true,
		'wp-head-callback'       => 'wk_wow_header_style',
...
add_action( 'after_setup_theme', 'wk_wow_custom_header_setup' );

if ( ! function_exists( 'wk_wow_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see wk_wow_custom_header_setup().
 */
function wk_wow_header_style() {
